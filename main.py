...
def quiz_results(filtered_ranks, score, question_amount, wrong_answers, percentage):
    os.system('cls' if os.name == 'nt' else 'clear')
...
def main():
    ...
    filtered_ranks, score, question_amount, wrong_answers, percentage = quiz_results(filtered_ranks, score, question_amount, wrong_answers, percentage)

...
def filter_topic(questions, topic_choice):
    ...
    # filtered_ranks = [question["Rank"] for question in filtered_questions]
    filtered_ranks = 0
    # score = 0
    # question_number = 0
    # question_amount = 0
...
def main():
    ...
    quiz_questions(filtered_questions, score, question_number, question_amount, number_of_questions, wrong_answers)

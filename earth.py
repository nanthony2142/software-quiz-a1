...
questions = [
    ...
    {"Question":"Which of these materials is soil NOT made of?","Options":["a) Clay","b) Charcoa", "c) Silt", "d) Sand"],"Answer": "b"},
    {"Question":"Which of these minerals is the LEAST hard?","Options":["a) Quartz","b) Diamond","c) Calcite","d) Fluorite"],"Answer": "c"},
    ...
    {"Question":"Which of these is the oldest period of time shown?","Options":["a) Jurassic","b) Triassic","c) Cretaceous","d) Paleogene"],"Answer": "b"},
    {"Question":"What is the first horizon of soil called?","Options":["a) O-horizion","b) A-horizon","c) B-horizon","d) P-horizon"],"Answer": "a"},
    {"Question":"Which of these animal's was the first to exist?","Options":["a) Bee","b) Tyrannosaurus rex","c) Arthropleura","d) Megalodon"],"Answer": "c"},
    ...
    {"Question":"Which layer of Earth is made of liquid?","Options":["a) the Crust","b) the Mantle","c) the Outer Core","d) the Inner Core"],"Answer": "c"},
    {"Question":"How are we able to date how old rocks are?","Options":["a) Fossil Frequency Analysis – The number of fossils in a rock layer is counted, and more fossils mean an older rock.","b) Radiometric Dating – Scientists measure the decay of radioactive isotopes, like uranium turning into lead, to determine a rock’s age.","c) Crystal Vibration Timing – By measuring how fast the tiny crystals inside the rock vibrate, scientists can calculate its age.","d) Rock Hardness Progression – Rocks get harder over time, so geologists test how difficult they are to scratch to determine their age."],"Answer": "b"},
    {"Question":"What are the main two elements that are used in Radiometric Dating?","Options":["a) Iron and Hydrogen","b) Iron and Carbon","c) Lead and Uranium","d) Uranium and Carbon"],"Answer": "d"},
    {"Question":"What is NOT a real rock type?","Options":["a) Metamorphic","b) Cryllic","c) Igneous","d) Sedimentary"],"Answer": "b"},
    {"Question":"Which piece of evidence is NOT used to help identify Earth's layers?","Options":["a) Seismic Waves","b) Meteorites","c) Volcanos","d) Mining"],"Answer": "d"},
